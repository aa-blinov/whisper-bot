...
LLM_PROMPT_TEMPLATE = (
    "Исправь только грамматические и пунктуационные ошибки в следующем тексте на русском языке. "
    "Не перефразируй текст, не добавляй новую информацию, не удаляй смысл. "
    "Верни только исправленный текст, без каких-либо вводных фраз или пояснений:\n\n{text}"
)
